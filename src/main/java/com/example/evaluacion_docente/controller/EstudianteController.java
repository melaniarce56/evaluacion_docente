...
import com.example.evaluacion_docente.service.EstudianteService;
...
public class EstudianteController {
    ...
    @PostMapping("/crear")
    public ResponseEntity<Estudiante> crear(Estudiante estudiante) {
    ...
    public ResponseEntity<Estudiante> actualizar(@PathVariable Integer id, @RequestBody Estudiante estudiante) {
        ...
        if (estudiante1 == null){
            ...
            return new ResponseEntity<>(estudianteService.create(estudiante1), HttpStatus.OK);
        }
    }
